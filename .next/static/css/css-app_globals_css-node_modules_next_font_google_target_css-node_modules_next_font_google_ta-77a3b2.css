...
.bg-status-success {
  --tw-bg-opacity: 1;
  background-color: rgb(0 255 135 / var(--tw-bg-opacity, 1));
}
.bg-status-warning {
  --tw-bg-opacity: 1;
...
.bg-williams-dark\/40 {
  background-color: rgb(2 11 28 / 0.4);
}
.bg-williams-dark\/90 {
  background-color: rgb(2 11 28 / 0.9);
}
.bg-williams-navy\/40 {
  background-color: rgb(4 30 66 / 0.4);
}
.bg-williams-navy\/60 {
  background-color: rgb(4 30 66 / 0.6);
}
.bg-williams-navy\/80 {
  background-color: rgb(4 30 66 / 0.8);
}
.bg-williams-navy\/95 {
  background-color: rgb(4 30 66 / 0.95);
}
.p-1 {
  padding: 0.25rem;
}
...
body {
  --tw-bg-opacity: 1;
  background-color: rgb(2 11 28 / var(--tw-bg-opacity, 1));
  font-family: var(--font-inter), sans-serif;
  --tw-text-opacity: 1;
  color: rgb(255 255 255 / var(--tw-text-opacity, 1));
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
  background: linear-gradient(135deg, var(--williams-dark) 0%, var(--williams-navy) 50%, #020B1C 100%);
  min-height: 100vh;
}

/* Telemetry-style grid background with subtle animation */
.telemetry-bg {
  background-image: 
  ...
  animation: telemetry-pulse 8s ease-in-out infinite;
}
...
::-webkit-scrollbar-track {
  border-radius: 9999px;
  background-color: rgb(4 30 66 / 0.5);
}
...
.hover\:border-williams-blue\/60:hover {
  border-color: rgb(0 174 239 / 0.6);
}

.hover\:bg-status-warning\/10:hover {
  background-color: rgb(255 209 102 / 0.1);
}

.hover\:bg-williams-blue\/10:hover {
  background-color: rgb(0 174 239 / 0.1);
}

.hover\:bg-williams-blue\/20:hover {
  background-color: rgb(0 174 239 / 0.2);
}

.hover\:bg-williams-light-blue:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(108 211 255 / var(--tw-bg-opacity, 1));
}
